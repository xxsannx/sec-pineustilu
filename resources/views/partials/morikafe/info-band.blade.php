<section class="bg-[#017249] text-white py-16">
    <div class="max-w-6xl mx-auto px-6 space-y-12">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
                <img src="{{ asset('images/morikafe-galeri/view1.jpg') }}" alt="kafe" class="w-full h-56 md:h-64 object-cover rounded-2xl shadow-md">
            </div>
            <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div class="order-1 md:order-2">
                <img src="{{ asset('images/morikafe-galeri/view2.jpg') }}" alt="peristirahatan" class="w-full h-56 md:h-64 object-cover rounded-2xl shadow-md">
            </div>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
                <img src="{{ asset('images/morikafe-galeri/view3.jpg') }}" alt="suasana" class="w-full h-56 md:h-64 object-cover rounded-2xl shadow-md">
            </div>
            <div>
