...
<section class="bg-white rounded-xl shadow-md p-5 border-2 border-[#017249]/10">
    ...
    <div class="space-y-3 mb-5">
        ...
        <div>
            ...
            <input id="outPhone" name="phone" type="tel"
                ...
                placeholder="08xxxxxxxx" value="{{ old('phone', $prefill['phone'] ?? '') }}" {{ ($isAuth && !$isGoogle) ? 'readonly' : '' }} required>
        </div>
    </div>
    ...
    <div>
        <div class="flex items-start gap-2 mb-4">
            <input type="checkbox" id="outAgree" name="agree" class="h-4 w-4 mt-0.5 text-[#017249] border-gray-300 rounded focus:ring-[#017249] cursor-pointer" required>
            <label for="outAgree" class="text-xs text-gray-600 cursor-pointer">Saya setuju dengan Syarat & Ketentuan yang berlaku</label>
        </div>
        <button type="submit"
