...
<section class="bg-white rounded-xl shadow-md p-5 border-2 border-[#017249]/10">
    ...
    <div>
        <div class="flex items-start gap-2 mb-4">
            <input type="checkbox" id="agree" name="agree" class="h-4 w-4 mt-0.5 text-[#017249] border-gray-300 rounded focus:ring-[#017249] cursor-pointer">
            <label for="agree" class="text-xs text-gray-600 cursor-pointer">I agree to the Terms & Conditions</label>
        </div>
        <button type="submit"
