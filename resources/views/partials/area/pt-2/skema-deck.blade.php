  ...
  <div class="max-w-4xl mx-auto px-6">
    <div class="text-center mb-8">
      <p class="text-green-700 font-medium">
        Ideal untuk keluarga, Pineus Tilu 2 dilengkapi dengan kolam bermain anak, menciptakan area yang
        menyenangkan dan aman bagi anak-anak untuk bermain, sementara orang tua dapat bersantai menikmati alam.
      </p>
    </div>
