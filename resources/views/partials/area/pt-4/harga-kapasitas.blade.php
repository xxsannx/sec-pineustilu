                ...
                <div class="space-y-3 mb-6">
                    <div>
                        ...
                        <div id="price-weekdays" class="price-panel bg-white/5 rounded p-4 mt-2 hidden">
                            <p class="text-sm leading-relaxed">Semua Plot (Tenda 4.2) <span class="font-bold">IDR 750.000</span> /Malam</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="price-weekend" class="price-panel bg-white/5 rounded p-4 mt-2 hidden">
                            <p class="text-sm leading-relaxed">Semua Plot (Tenda 4.2) <span class="font-bold">IDR 950.000</span> /Malam</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="price-high" class="price-panel bg-white/5 rounded p-4 mt-2 hidden">
                            <p class="text-sm leading-relaxed">Semua Plot <span class="font-bold">IDR 1.100.000</span> /Malam</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-3 mb-6">
                    <div>
                        ...
                        <div id="cap-standard" class="cap-panel bg-white/5 rounded p-4 mt-2 hidden">
                            <p class="text-sm mb-2"><span class="font-semibold">Standar 4 orang</span> — <span class="font-semibold">Maksimal 6 orang</span></p>
                            <p class="text-sm italic">Tamu di atas 2 tahun dikenakan biaya.</p>
                        </div>
                    </div>

                    <div>
                        <button type="button" class="ft-toggle w-full text-left flex items-center justify-between px-4 py-3 bg-white/5 border border-white/10 rounded" data-target="cap-additional" data-group="capacity" aria-expanded="false">
                        ...
                        <div id="cap-additional" class="cap-panel bg-white/5 rounded p-4 mt-2 hidden">
                            ...
                            <p class="text-sm leading-relaxed"><span class="font-bold">IDR 100.000/orang</span><br><em class="text-sm">(kantong tidur, sarapan, kasur busa + bantal)</em></p>
                            <p class="text-sm leading-relaxed mt-3">atau<br><span class="font-bold">IDR 40.000/orang</span><br><em class="text-sm">(hanya sarapan)</em></p>
                        </div>
                    </div>
                </div>

                <p class="text-sm text-white/90 mt-2">Untuk informasi tambahan atau permintaan khusus, silakan hubungi admin reservasi.</p>
            </div>
        </div>
    </div>
</section>
