<div class="story-box story-box--center" data-lang="ja" lang="ja">
    <div class="story-box-inner">
        ...
        <p>コンビニで休憩していたとき、誰かが「川べりでテント泊してみては」と提案してくれました。面白そうだと思い、パラヤンガン川のほとりでフランス製のアルペナズ・ファミリー4.0のテントを使ってキャンプをしました。
        </p>
        ...
        <p>その場所は景観が美しく、プライベート感があり、川に向かって傾く3本の松が特徴でした。これが現在のPINEUS
            TILUリバーサイド・キャンプ場になりました。初期計画では、木製デッキ7基にアルペナズ・ファミリー4.0／4.2のテント9張を配置しています。ぜひこの特別な雰囲気を体験してください。</p>
    </div>
</div>