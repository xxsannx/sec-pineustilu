<!-- Map Modal -->
<div id="mapModal" class="fixed inset-0 z-[9999] backdrop-blur-sm bg-black/60 items-center justify-center hidden">
    <div class="relative w-full h-full">
        <!-- Close Button -->
        <button data-close-modal="map"
        ...
        <div class="absolute top-6 left-6 z-[10001] flex flex-col gap-2">
            <button onclick="event.stopPropagation(); window.dashboardInstance.zoomIn();"
            ...
            <button onclick="event.stopPropagation(); window.dashboardInstance.zoomOut();"
                class="bg-white hover:bg-gray-100 text-gray-800 rounded-full p-3 shadow-xl transition-all duration-300 hover:scale-110 cursor-pointer">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <button onclick="event.stopPropagation(); window.dashboardInstance.resetZoom();"
                class="bg-white hover:bg-gray-100 text-gray-800 rounded-full p-3 shadow-xl transition-all duration-300 hover:scale-110 cursor-pointer">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <!-- Instructions -->
        <div
            class="absolute bottom-6 right-6 z-[10001] bg-white rounded-lg px-4 py-2 shadow-xl max-w-xs hidden md:block">
        ...
        <!-- Map Image Container -->
        <div id="mapContainer" class="absolute inset-0 flex items-center justify-center overflow-hidden touch-none"
            onclick="event.stopPropagation();">
            <img id="mapImage" src="{{ asset('images/fullmap.jpeg') }}" alt="Peta Pineus Tilu Camp Ground"
                class="max-h-[90vh] max-w-[90vw] object-contain select-none transition-none cursor-grab"
                draggable="false">
        </div>
    </div>
</div>
