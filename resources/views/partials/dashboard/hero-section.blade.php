...
<section class="relative px-4 min-h-screen flex items-start pt-32 md:pt-40 bg-[#1a1a1a] bg-cover bg-center bg-no-repeat overflow-hidden w-full" style="background-image: linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.45)), url('/images/suasana.jpg');">
    ...
    <div class="max-w-7xl mx-auto relative z-10 w-full overflow-hidden">
        <div class="text-center" data-aos="fade-up" data-aos-duration="1000">
            <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-6 md:mb-8 leading-tight px-4 drop-shadow-[3px_3px_6px_rgba(0,0,0,0.8)] whitespace-nowrap" style="font-family: 'Bizon', sans-serif;">
