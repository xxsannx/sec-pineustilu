<div class="bg-white rounded-lg shadow-sm overflow-hidden p-8">
    <section class="max-w-screen-xl mx-auto">
        <h2 class="text-3xl md:text-4xl font-extrabold text-center text-[#017249] mb-8">TEMPAT PARKIR</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
            ...
            <div class="text-[#0b5a3e]">
                ...
                <ul class="list-disc list-inside marker:text-[#017249] space-y-2 text-base md:text-lg mb-6">
                ...
                <ul class="list-disc list-inside marker:text-[#017249] space-y-2 text-base md:text-lg">
                ...
                <p class="text-sm text-gray-700">Biaya parkir dikelola oleh pengelola parkir terpisah, bukan oleh Pineus
                    Tilu. Pembayaran harus dilakukan langsung di lokasi kepada pihak pengelola parkir.</p>
            </div>
        </div>
    </section>
</div>
