        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 w-full" data-aos="fade-up" data-aos-duration="800">
            ...
            <div data-aos="fade-up" data-aos-delay="200">
                ...
                <ul class="space-y-1 text-sm">
                    ...
                    <li><a href="#" class="text-gray-600 hover:text-[#017249] transition-colors">Pembatalan</a></li>
                </ul>
            </div>
            ...
            <div data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="space-y-2 text-sm text-gray-600">
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5 text-[#017249] flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="space-y-2">
                    <input type="email" placeholder="Contoh : Email@Domain.Com" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#017249]">
                    <button class="w-full bg-[#017249] hover:bg-[#015a3a] text-white py-2 px-4 rounded-lg text-sm font-medium transition duration-300">
                        Kirim
                    </button>
                </div>
            </div>
