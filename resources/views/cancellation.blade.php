                ...
                @if(isset($booking) && $booking)
                    <div class="mt-10 bg-white rounded-2xl shadow-lg border border-gray-200 p-6 md:p-8 text-left">
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-100">
                            ...
                            <form action="{{ route('cancellation.process') }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin membatalkan booking ini? Tindakan ini tidak dapat dibatalkan.');">
                                @csrf
                                <input type="hidden" name="code" value="{{ $booking->token_code }}">
                                ...
                                <button type="submit" class="w-full sm:w-auto px-8 py-3 bg-red-600 text-white font-semibold rounded-xl hover:bg-red-700 transition-colors">
